...
export function analyzeFirestoreError(error: any): FirestoreErrorInfo {
  ...
  if (
    ...
    return {
      ...
      isRetryable: true,
      userMessage:
        "Connection issue detected. Working to restore connection...",
      suggestedAction: "wait",
    };
  }
  ...
  if (errorMessage.includes("circuit breaker")) {
    return {
      ...
      isRetryable: false,
      userMessage:
        "Service is temporarily unavailable due to connection issues. Please wait a moment.",
      suggestedAction: "wait",
    };
  }
