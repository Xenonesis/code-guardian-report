    ...
    <div className="container mx-auto max-w-6xl px-4 py-8">
      <div className="mb-8">
        <h1 className="mb-4 flex items-center gap-3 text-4xl font-bold">
          <Bell className="text-primary h-10 w-10" />
      ...
      <Card className="mt-8">
        ...
        <CardContent className="space-y-4">
          <div>
            <h4 className="mb-2 font-semibold">1. Open Notification Center</h4>
          ...
          <div>
            <h4 className="mb-2 font-semibold">2. Configure Preferences</h4>
            <p className="text-muted-foreground text-sm">
              Click the settings icon in the notification center to customize:
            </p>
            <ul className="text-muted-foreground mt-2 ml-4 list-inside list-disc text-sm">
          ...
          <div>
            <h4 className="mb-2 font-semibold">3. Test Features</h4>
            <p className="text-muted-foreground text-sm">
          ...
          <div>
            <h4 className="mb-2 font-semibold">4. Manage Notifications</h4>
            <p className="text-muted-foreground text-sm">
