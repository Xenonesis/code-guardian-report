                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-orange-800">
                        {results.dependencyAnalysis?.summary.criticalVulnerabilities || 0}
                      </p>
          ...
          <TabsContent value="threats" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Detected security threats and vulnerabilities in the ZIP archive
                </CardDescription>
              </CardHeader>
              <CardContent>
                {results.zipAnalysis!.securityThreats.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-green-600">The ZIP file appears to be safe</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                      ...
                      <Alert key={index} className="border-l-4 border-l-red-500">
                        ...
                        <div className="ml-4">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            {threat.cweId && <Badge variant="secondary">{threat.cweId}</Badge>}
                          </div>
                          <h4 className="font-semibold">{threat.description}</h4>
                          <p className="text-sm text-gray-600 mb-2">File: {threat.file}</p>
                          ...
                          <div className="bg-blue-50 p-3 rounded-md">
                            <p className="text-sm font-medium text-blue-800">Mitigation:</p>
                            <p className="text-sm text-blue-700">{threat.mitigation}</p>
                          </div>
                        </div>
                      </Alert>
                    ))}
            ...
            {results.dependencyAnalysis ? (
                  ...
                  <Card>
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-2xl font-bold">{results.dependencyAnalysis.summary.totalPackages}</p>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-2xl font-bold text-red-600">
                            {results.dependencyAnalysis.summary.criticalVulnerabilities}
                          </p>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-2xl font-bold text-orange-600">
                            {results.dependencyAnalysis.summary.outdatedPackages}
                          </p>
                ...
                <Card>
                  ...
                  <CardContent>
                    {results.dependencyAnalysis.vulnerabilities.length === 0 ? (
                      <div className="text-center py-8">
                        <CheckCircle className="h-12 w-12 text-green-500 mx-auto mb-4" />
                        <h3 className="text-lg font-medium text-green-700">No Vulnerabilities Found</h3>
                        <p className="text-green-600">All dependencies appear to be secure</p>
                      </div>
                    ) : (
                      <div className="space-y-4">
                        {results.dependencyAnalysis.vulnerabilities.map((vuln, index) => (
                          <div key={index} className="border rounded-lg p-4">
                            <div className="flex items-start justify-between mb-2">
                              <div>
                                <h4 className="font-semibold">{vuln.vulnerability.title}</h4>
                                <p className="text-sm text-gray-600">
                            ...
                            <p className="text-sm mb-3">{vuln.vulnerability.description}</p>
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600">No dependency information available</p>
                </CardContent>
              </Card>
            )}
          </TabsContent>
              ...
              <CardContent>
                {results.zipAnalysis!.complianceIssues.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-green-600">Code appears to meet compliance standards</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {results.zipAnalysis!.complianceIssues.map((issue, index) => (
                      <Alert key={index}>
                        ...
                        <AlertDescription>
                          <div className="space-y-2">
                            <div className="flex items-center gap-2">
                              <Badge variant="outline">{issue.standard}</Badge>
