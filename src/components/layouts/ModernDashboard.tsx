...
export const ModernDashboard: React.FC<ModernDashboardProps> = ({ 
  ...
  const mockMetrics = {
    totalIssues: analysisResults?.issues?.length || 42,
    criticalIssues: analysisResults?.criticalIssues || 8,
    warningIssues: analysisResults?.warningIssues || 15,
    infoIssues: analysisResults?.infoIssues || 19,
    filesScanned: analysisResults?.totalFiles || 156,
    linesOfCode: analysisResults?.linesOfCode || 12847,
    securityScore: analysisResults?.securityScore || 78,
  ...
  return (
    <div className={`space-y-8 ${className}`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <MetricsCard
          title="Files Scanned"
          value={mockMetrics.filesScanned}
        ...
        <MetricsCard
          title="Lines of Code"
          value={mockMetrics.linesOfCode.toLocaleString()}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <MetricsCard
          ...
          value={`${mockMetrics.securityScore}%`}
          subtitle="Based on vulnerability analysis"
          icon={Shield}
          score={mockMetrics.securityScore}
          showProgress={true}
          variant="modern"
          colorScheme="green"
          trend="up"
        ...
        <MetricsCard
          ...
          value={`${mockMetrics.qualityScore}%`}
          subtitle="Overall code health rating"
          icon={Target}
          score={mockMetrics.qualityScore}
          showProgress={true}
          variant="modern"
          colorScheme="blue"
          trend="up"
