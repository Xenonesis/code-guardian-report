      ...
      <Tabs defaultValue="overview" className="w-full">
        <div className="sticky top-0 z-20 bg-gradient-to-b from-white via-white/98 to-white/95 dark:from-slate-900 dark:via-slate-900/98 dark:to-slate-900/95 backdrop-blur-2xl pb-6 mb-8 border-b border-slate-200/50 dark:border-slate-700/50">
          <div className="flex justify-center">
            <TabsList className="flex w-full sm:w-auto gap-2 overflow-x-auto bg-slate-100/50 dark:bg-slate-800/50 backdrop-blur-xl border border-slate-200/60 dark:border-slate-700/60 shadow-sm rounded-2xl p-1.5 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
              <TabsTrigger
                value="overview"
                className="flex-shrink-0 min-w-[120px] sm:min-w-[140px] flex items-center justify-center gap-2 py-2.5 px-4 text-sm font-medium text-slate-600 dark:text-slate-400 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-700 data-[state=active]:text-blue-600 dark:data-[state=active]:text-blue-400 data-[state=active]:shadow-sm transition-all duration-200 rounded-xl group"
              >
              ...
              {hasLanguageDetection && (
                <TabsTrigger
                  ...
                  className="flex-shrink-0 min-w-[120px] sm:min-w-[140px] flex items-center justify-center gap-2 py-2.5 px-4 text-sm font-medium text-slate-600 dark:text-slate-400 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-700 data-[state=active]:text-purple-600 dark:data-[state=active]:text-purple-400 data-[state=active]:shadow-sm transition-all duration-200 rounded-xl group"
                >
              ...
              <TabsTrigger
                ...
                className="flex-shrink-0 min-w-[120px] sm:min-w-[140px] flex items-center justify-center gap-2 py-2.5 px-4 text-sm font-medium text-slate-600 dark:text-slate-400 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-700 data-[state=active]:text-green-600 dark:data-[state=active]:text-green-400 data-[state=active]:shadow-sm transition-all duration-200 rounded-xl group"
              >
              ...
              <TabsTrigger
                value="ai-insights"
                className="flex-shrink-0 min-w-[120px] sm:min-w-[140px] flex items-center justify-center gap-2 py-2.5 px-4 text-sm font-medium text-slate-600 dark:text-slate-400 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-700 data-[state=active]:text-orange-600 dark:data-[state=active]:text-orange-400 data-[state=active]:shadow-sm transition-all duration-200 rounded-xl group"
              >
              ...
              <TabsTrigger
                value="metrics"
                className="flex-shrink-0 min-w-[120px] sm:min-w-[140px] flex items-center justify-center gap-2 py-2.5 px-4 text-sm font-medium text-slate-600 dark:text-slate-400 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-700 data-[state=active]:text-emerald-600 dark:data-[state=active]:text-emerald-400 data-[state=active]:shadow-sm transition-all duration-200 rounded-xl group"
              >
