...
import { Shield, AlertTriangle, Target, Key, TrendingUp, Info } from 'lucide-react';
        ...
        <div className="flex items-center justify-center md:justify-between px-3 sm:px-6 py-4 sm:py-5 border-b border-slate-200/60 dark:border-slate-700/60">
          <div className="flex items-center justify-center md:justify-start gap-2 sm:gap-3">
            ...
            <div className="flex md:hidden flex-col items-start leading-tight">
              <span className="text-sm font-bold bg-gradient-to-r from-slate-900 to-blue-900 dark:from-white dark:to-blue-100 bg-clip-text text-transparent">Code Guardian</span>
              <span className="text-[10px] uppercase tracking-wide text-slate-500 dark:text-slate-400 font-medium">Security Analysis</span>
            </div>
            <div className="hidden md:flex flex-col">
              <span className="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Executive Summary</span>
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Security Analysis Overview</h3>
            </div>
          </div>
          <div className="hidden md:flex flex-col items-end text-sm text-slate-500 dark:text-slate-400">
            <span>
              <span className="font-semibold text-slate-900 dark:text-slate-100">{results.totalFiles}</span> files
            </span>
            <span>
              <span className="font-semibold text-slate-900 dark:text-slate-100">{results.summary.linesAnalyzed.toLocaleString()}</span> lines analyzed
            </span>
          </div>
        </div>
        ...
        <div className="px-3 sm:px-6 py-4">
          ...
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs">
              ...
              <p className="text-xs">Based on severity and density of issues.</p>
          ...
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs">
              ...
              <p className="text-xs">Critical ({results.summary.criticalIssues}) + High ({results.summary.highIssues}) severity issues requiring immediate attention.</p>
            </TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs">
              ...
              <p className="text-xs">Issues per 1,000 lines. Benchmark: &lt;5. Lower is better.</p>
            </TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs">
              ...
              <p className="text-xs">API keys, passwords, tokens found in code. Should NEVER be committed.</p>
            </TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs">
              ...
              <p className="text-xs">Based on maintainability, complexity, and best practices.</p>
            </TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs">
              ...
              <p className="text-xs">All security and quality concerns found.</p>
              <div className="mt-2 text-xs space-y-0.5">
