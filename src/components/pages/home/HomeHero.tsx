        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
          ...
          >
            ...
            <div className="relative flex items-center justify-center gap-3 sm:gap-4">
              ...
              <span className="whitespace-nowrap bg-gradient-to-r from-slate-700 to-slate-900 dark:from-white dark:to-slate-200 bg-clip-text text-transparent">
                Live Demo
              </span>
            </div>
          </Button>
          ...
          >
            {showFeatures && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                <div
                  className="flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-white/20 to-white/10 
