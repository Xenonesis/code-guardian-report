      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Verify that the analysis engine detects real vulnerabilities accurately and doesn't return mock/fake data
          </p>
        </CardHeader>
        <CardContent>
          <Button
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="mt-2 space-y-1 text-sm text-green-800 dark:text-green-200">
                        <li>✅ Analysis engine is providing accurate, real results</li>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className={`font-semibold ${getStatusColor(detail.status)}`}>
                          {detail.testName}
                        </h4>
                        ...
                        {detail.actualIssues !== undefined && (
                          <div className="mt-2 text-xs text-muted-foreground">
                            ...
                            {detail.expectedMin && ` (expected: ${detail.expectedMin}+)`}
                          </div>
                        )}
                      </div>
                    </div>
