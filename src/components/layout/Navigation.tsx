      ...
      <div className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 xs:h-15 sm:h-16 md:h-[64px] lg:h-[68px]">
          ...
          >
            ...
            <div className="relative flex-shrink-0">
              ...
              <div className="relative p-1.5 xs:p-2 sm:p-2.5 rounded-xl bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:rotate-3">
                <Shield className="h-4 w-4 xs:h-5 xs:w-5 sm:h-6 sm:w-6 text-white drop-shadow-sm" strokeWidth={2.5} />
          ...
          <div className="flex items-center gap-1 xs:gap-1.5 sm:gap-2 md:gap-3 flex-shrink-0">
            ...
            {/* Theme Toggle */}
            <ThemeToggle theme={theme} onThemeChange={onThemeChange} className="h-8 w-8 xs:h-9 xs:w-9 sm:h-10 sm:w-10 rounded-full bg-slate-100/80 dark:bg-slate-800/50 hover:bg-slate-200/80 dark:hover:bg-slate-700/50 transition-all duration-200" />
              ...
              {user ? (
                <div className="space-y-2 xs:space-y-3">
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <span className="text-sm xs:text-base font-semibold">Sign Out</span>
                ...
                <div className="space-y-2 xs:space-y-3">
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <span className="text-sm xs:text-base font-semibold">Sign In</span>
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <span className="text-sm xs:text-base font-semibold">Get Started</span>
