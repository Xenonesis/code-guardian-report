  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {/* Multi-layered Gradient Orbs with Refined Animations */}
        <div className="animate-float-slow absolute top-1/4 left-1/4 h-40 w-40 rounded-full bg-gradient-to-r from-blue-500/20 via-violet-500/15 to-fuchsia-500/20 blur-3xl sm:h-56 sm:w-56 md:h-80 md:w-80"></div>
        <div className="animate-float-delayed absolute right-1/4 bottom-1/4 h-32 w-32 rounded-full bg-gradient-to-r from-emerald-500/15 via-teal-500/12 to-cyan-500/15 blur-3xl sm:h-48 sm:w-48 md:h-64 md:w-64"></div>
        <div className="animate-pulse-slow absolute top-1/2 left-1/2 h-56 w-56 -translate-x-1/2 -translate-y-1/2 transform rounded-full bg-gradient-to-r from-amber-500/10 via-rose-500/8 to-orange-500/10 blur-3xl sm:h-80 sm:w-80 md:h-[28rem] md:w-[28rem]"></div>

        {/* Additional Floating Orbs for Depth */}
        <div className="animate-float float-animation delay-2s absolute top-16 right-16 h-24 w-24 rounded-full bg-gradient-to-r from-violet-500/12 to-purple-500/12 blur-2xl sm:h-32 sm:w-32"></div>
        <div className="animate-float float-animation delay-4s absolute bottom-16 left-16 h-28 w-28 rounded-full bg-gradient-to-r from-amber-500/12 to-orange-500/12 blur-2xl sm:h-36 sm:w-36"></div>

        {/* Enhanced Floating Icons with Subtler Colors */}
        <div className="animate-float absolute top-20 left-12 sm:top-24 sm:left-24">
          <Shield className="h-5 w-5 text-blue-500/30 sm:h-7 sm:w-7" />
        </div>
        <div className="animate-float-delayed absolute top-32 right-12 sm:top-40 sm:right-40">
          <Code className="h-6 w-6 text-violet-500/30 sm:h-9 sm:w-9" />
        </div>
        <div className="animate-bounce-slow absolute bottom-32 left-12 sm:bottom-40 sm:left-40">
          <Bot className="h-6 w-6 text-emerald-500/30 sm:h-8 sm:w-8" />
        </div>
        <div className="animate-float absolute top-1/3 right-8 sm:right-20">
          <Sparkles className="h-4 w-4 text-cyan-500/25 sm:h-6 sm:w-6" />
        </div>
        <div className="animate-float-delayed absolute right-1/3 bottom-1/3">
          <Stars className="h-5 w-5 text-fuchsia-500/25 sm:h-7 sm:w-7" />
        </div>
        <div className="animate-bounce-slow absolute top-2/3 left-8 sm:left-20">
          <Zap className="h-5 w-5 text-amber-500/25 sm:h-7 sm:w-7" />
        </div>
      </div>
