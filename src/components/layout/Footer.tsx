...
export const Footer: React.FC<FooterProps> = ({ className = '' }) => {
  ...
  return (
    <footer className={`relative overflow-hidden bg-gradient-to-br from-slate-100 via-blue-50 to-slate-100 dark:from-slate-950 dark:via-blue-950 dark:to-slate-950 border-t border-slate-200/50 dark:border-slate-700/30 ${className}`}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-slate-900 to-blue-900 dark:from-white dark:to-blue-100 bg-clip-text text-transparent">
                  Code Guardian
                </h3>
            ...
            <p className="text-slate-700 dark:text-slate-300 mb-8 max-w-md leading-relaxed">
              ...
              {footerLinks.main.map((link) => (
                <li key={link.id}>
                  <button
                    ...
                    className="text-slate-700 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white transition-all duration-300 group flex items-center gap-2"
                  >
        ...
        <div className="border-t border-slate-300/50 dark:border-slate-700/50 pt-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-400/30 text-emerald-900 dark:text-emerald-100 hover:from-emerald-500/30 hover:to-teal-500/30 transition-all duration-300 backdrop-blur-sm"
              >
                <Mail className="h-4 w-4" />
                <span className="text-sm font-medium">Contact</span>
              </a>
              <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-200/50 border border-slate-300/50 dark:bg-slate-800/50 dark:border-slate-700/50 backdrop-blur-sm">
          ...
          <div className="mt-8 pt-6 border-t border-slate-300/50 dark:border-slate-700/50">
            <div className="flex flex-wrap items-center justify-center gap-8 text-xs text-slate-600 dark:text-slate-400">
              <div className="flex items-center gap-2 group">
                <div className="p-1 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-full">
                  <Globe className="h-3 w-3 text-blue-600 group-hover:text-blue-700 dark:text-blue-300 dark:group-hover:text-blue-200 transition-colors duration-300" />
                </div>
              ...
              <div className="flex items-center gap-2 group">
                <div className="p-1 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-full">
                  <Shield className="h-3 w-3 text-green-600 group-hover:text-green-700 dark:text-green-300 dark:group-hover:text-green-200 transition-colors duration-300" />
                </div>
              ...
              <div className="flex items-center gap-2 group">
                <div className="p-1 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full">
                  <Users className="h-3 w-3 text-purple-600 group-hover:text-purple-700 dark:text-purple-300 dark:group-hover:text-purple-200 transition-colors duration-300" />
                </div>
