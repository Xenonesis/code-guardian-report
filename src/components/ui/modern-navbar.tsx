...
import { Menu, X, Home, User, Briefcase, FileText, Settings } from "lucide-react"
      ...
      <main className="container mx-auto px-4 pt-24">
        <div className="text-center space-y-4 py-20">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            A sleek navigation bar with smooth animations, responsive design, and scroll-based behavior. 
          ...
          {Array.from({ length: 10 }).map((_, i) => (
            <div key={i} className="bg-muted rounded-lg p-8">
              ...
              <p className="text-muted-foreground">
                This is some content to demonstrate the scroll behavior of the navbar. 
                The navbar will automatically collapse when scrolling down and expand when scrolling up.
              </p>
            </div>
          ))}
        </div>
