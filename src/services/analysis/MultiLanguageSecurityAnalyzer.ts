...
export class MultiLanguageSecurityAnalyzer {
  ...
  private initializeSecurityRules(): LanguageSecurityRule[] {
    return [
      // JavaScript/TypeScript Rules
      {
        ...
        owasp: "A03:2021",
        recommendation:
          "Avoid using eval(). Use safer alternatives like JSON.parse() or Function constructors with strict validation.",
      },
      {
        ...
        owasp: "A03:2021",
        recommendation:
          "Use textContent, createElement, or a sanitization library like DOMPurify.",
      },
      {
      ...
      // Python Rules
      {
        ...
        description:
          "exec() can execute arbitrary code and lead to code injection",
        severity: "Critical",
        pattern: /\bexec\s*\(/g,
        languages: ["python"],
        cwe: "CWE-95",
        owasp: "A03:2021",
        recommendation:
          "Avoid using exec(). Redesign your code to avoid dynamic code execution.",
      },
      {
        id: "py-pickle-load",
        ...
        owasp: "A08:2021",
        recommendation:
          "Use safer serialization formats like JSON. If pickle is required, validate and sign the data.",
      },
      {
        id: "py-sql-format",
        ...
        owasp: "A03:2021",
        recommendation:
          "Use parameterized queries with placeholders (?) or named parameters.",
      },
      {
      ...
      },
      {
        ...
        owasp: "A08:2021",
        recommendation:
          "Implement input validation and use serialization filters.",
      },
      {
        id: "java-random",
      ...
      // C++ Rules
      {
        ...
        owasp: "A03:2021",
        recommendation:
          "Use safer alternatives: strncpy, strncat, snprintf, fgets.",
      },
      {
        id: "cpp-memory-leak",
      ...
      },
      {
        ...
        owasp: "A03:2021",
        recommendation:
          "Validate and sanitize all user inputs before using in commands.",
      },
      {
        ...
        owasp: "A01:2021",
        recommendation:
          "Validate and sanitize file paths. Use filepath.Clean and check for path traversal.",
      },
      ...
      // Rust Rules
      {
        ...
        owasp: "A04:2021",
        recommendation:
          "Minimize unsafe code. Ensure thorough review and testing of unsafe blocks.",
      },
      {
        ...
        owasp: "A04:2021",
        recommendation:
          "Use pattern matching or expect() with descriptive messages. Handle errors explicitly.",
      },
      {
      ...
      // PHP Rules
      {
        ...
        owasp: "A03:2021",
        recommendation:
          "Avoid eval(). Redesign code to eliminate need for dynamic code execution.",
      },
      {
      ...
      },
      {
        ...
        owasp: "A03:2021",
        recommendation:
          "Avoid executing system commands. If necessary, use escapeshellarg() and escapeshellcmd().",
      },
      {
        ...
        owasp: "A03:2021",
        recommendation:
          "Use a whitelist of allowed files. Never include files based on direct user input.",
      },
      ...
      },
      {
        ...
        description: "Executing system commands with user input",
        severity: "Critical",
        pattern: [/system\s*\(/g, /exec\s*\(/g, /`[^`]*#\{/g, /%x\{[^}]*#\{/g],
        languages: ["ruby"],
        cwe: "CWE-78",
        owasp: "A03:2021",
        recommendation:
          "Use safe command execution methods with proper escaping.",
      },
      {
        id: "ruby-yaml-load",
        name: "Unsafe YAML Loading",
      ...
      },
      {
        ...
        description:
          "Unprotected mass assignment can lead to privilege escalation",
        severity: "High",
        pattern: [
          /\.new\s*\(params\[/g,
          /\.create\s*\(params\[/g,
      ...
      },
      {
        ...
        owasp: "A03:2021",
        recommendation:
          "Avoid using eval. Use safer alternatives or validate input thoroughly.",
      },
      ...
      },
      {
        ...
        owasp: "A04:2021",
        recommendation:
          "Use optional binding (if let, guard let) or optional chaining instead.",
      },
      {
        ...
        owasp: "A02:2021",
        recommendation:
          "Use Keychain for sensitive data like passwords and tokens.",
      },
      {
        ...
        severity: "High",
        pattern: [/Insecure\.MD5/g, /Insecure\.SHA1/g],
        languages: ["swift"],
        cwe: "CWE-327",
        owasp: "A02:2021",
      ...
      // Kotlin Rules
      {
        ...
        description: "String concatenation in SQL queries",
        severity: "Critical",
        pattern: [/rawQuery\s*\([^)]*\+/g, /execSQL\s*\([^)]*\+/g],
        languages: ["kotlin"],
        cwe: "CWE-89",
        owasp: "A03:2021",
      ...
      },
      {
        ...
        owasp: "A03:2021",
        recommendation:
          "Only enable JavaScript if necessary and sanitize all content.",
      },
      {
      ...
      },
      {
        ...
        severity: "High",
        pattern: [/new\s+XmlTextReader\s*\(/g, /XmlDocument\s*\(\)\.Load/g],
        languages: ["csharp"],
        cwe: "CWE-611",
        owasp: "A05:2021",
        recommendation:
          "Set XmlReaderSettings.DtdProcessing to DtdProcessing.Prohibit.",
      },
      {
        ...
        owasp: "A08:2021",
        recommendation:
          "Use secure serialization methods like JSON.NET with type validation.",
      },
      {
        id: "cs-weak-crypto",
        name: "Weak Cryptographic Algorithm",
  ...
  private analyzePythonAST(
    ...
    for (const imp of ast.imports || []) {
      if (
        dangerousImports.some(
          (dangerous) =>
            imp.module?.includes(dangerous) ||
            imp.names?.some((n: string) => n.includes(dangerous))
        )
      ) {
        issues.push({
          ...
          description:
            "Import of module that can be misused for security vulnerabilities",
          line: imp.line,
          column: 0,
          file: filename,
          recommendation:
            "Review usage of this import and ensure proper validation of inputs.",
          cwe: "CWE-676",
        });
      }
    }
    ...
    for (const imp of ast.imports || []) {
      if (dangerousImports.some((dangerous) => imp.name?.includes(dangerous))) {
        issues.push({
          ...
          title: "Potentially Dangerous Import",
          description:
            "Import of class that requires careful security consideration",
          line: imp.line,
          column: 0,
          file: filename,
          recommendation:
            "Ensure proper security controls when using this class.",
          cwe: "CWE-676",
        });
      }
    }
    ...
    for (const imp of ast.imports || []) {
      if (dangerousImports.some((dangerous) => imp.path?.includes(dangerous))) {
        issues.push({
          ...
          title: "Potentially Dangerous Import",
          description:
            "Import of package that requires careful security consideration",
          line: imp.line,
          column: 0,
          file: filename,
    ...
    for (const func of ast.functions || []) {
      if (func.name.includes("unsafe") || func.name.includes("raw")) {
        issues.push({
          ...
          file: filename,
          recommendation:
            "Ensure unsafe code is thoroughly reviewed and tested.",
          cwe: "CWE-119",
        });
      }
    }
    ...
    for (const func of ast.functions || []) {
      if (func.name === "unserialize" || func.name === "eval") {
        issues.push({
          ...
          file: filename,
          recommendation:
            "Ensure this is intentional and inputs are properly validated.",
          cwe: "CWE-95",
        });
      }
    }
  ...
  private analyzeCSharpAST(
    ...
    const dangerousUsings = [
      "System.Runtime.Serialization.Formatters.Binary",
      "System.Web.Script.Serialization",
    ];
    for (const using of ast.usings || []) {
      if (
        dangerousUsings.some((dangerous) =>
          using.namespace?.includes(dangerous)
        )
      ) {
        issues.push({
          ...
          description:
            "Using statement for namespace with security implications",
          line: using.line,
          column: 0,
          file: filename,
  ...
  private analyzeRubyAST(
    ...
    for (const req of ast.requires || []) {
      if (
        dangerousRequires.some((dangerous) => req.module?.includes(dangerous))
      ) {
        issues.push({
          ...
          description:
            "Require of module that needs careful security consideration",
          line: req.line,
          column: 0,
          file: filename,
          recommendation: "Review usage and ensure proper input validation.",
    ...
    for (const imp of ast.imports || []) {
      if (androidImports.some((ai) => imp.module?.includes(ai))) {
        issues.push({
          ...
          description:
            "Import of Android component that requires security consideration",
          line: imp.line,
          column: 0,
          file: filename,
...
// Singleton instance
export const multiLanguageSecurityAnalyzer =
  new MultiLanguageSecurityAnalyzer();
