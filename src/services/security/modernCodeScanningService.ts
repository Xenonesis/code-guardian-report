...
export class ModernCodeScanningService {
  ...
  private initializeRules(): void {
    this.rules = [
      ...
      // SQL Injection
      {
        ...
        description:
          "Formatted SQL queries can be difficult to maintain, debug and is a potential security risk. Use parameterized queries instead.",
        severity: "Critical",
        type: "Vulnerability",
        ruleType: "Security",
        pattern:
          /(?:query|execute|exec|sql|prepare)\s*\([^)]*["'`][^"'`]*(?:\+|FROM|WHERE)[^)]*["'`]|["'`]\s*SELECT.*?["']\s*\+|["'`]\s*\+[^+]*(?:WHERE|FROM)/gi,
      ...
      // NoSQL Injection (NEW)
      {
        ...
        description:
          "NoSQL queries constructed from user input without sanitization are vulnerable to injection attacks.",
        severity: "Critical",
        type: "Vulnerability",
        ruleType: "Security",
      ...
      // XSS Vulnerabilities
      {
        ...
        description:
          "Setting HTML from user-controlled data without sanitization exposes your application to XSS attacks.",
        severity: "Critical",
        type: "Vulnerability",
        ruleType: "Security",
      ...
      // Command Injection
      {
        ...
        description:
          "Using OS commands with user input can lead to arbitrary command execution.",
        severity: "Critical",
        type: "Vulnerability",
        ruleType: "Security",
        pattern:
          /(?:exec|spawn|execSync|spawnSync|execFile)\s*\([^)]*(?:\+|`\$\{)/gi,
        languages: ["javascript", "typescript"],
      ...
      // Path Traversal
      {
        ...
        ruleType: "Security",
        pattern:
          /(?:readFile|writeFile|readFileSync|writeFileSync|createReadStream)\s*\([^)]*(?:\+|`\$\{)/gi,
        languages: ["javascript", "typescript"],
      ...
      // Hardcoded Secrets
      {
        ...
        description:
          "Hard-coded secrets can be extracted from source code and used maliciously.",
        severity: "Blocker",
        type: "Vulnerability",
        ruleType: "Security",
        pattern:
          /(?:password|secret|api[_-]?key|token|private[_-]?key)\s*[:=]\s*["'][^"']{8,}["']/gi,
      ...
      // SSRF Vulnerability (NEW for 2025)
      {
        ...
        description:
          "User-controlled URLs passed to HTTP clients can lead to SSRF attacks.",
        severity: "Critical",
        type: "Vulnerability",
        ruleType: "Security",
        pattern:
      ...
      // Prototype Pollution (NEW)
      {
        ...
        description:
          "Object merge operations with user input can lead to prototype pollution.",
        severity: "Critical",
        type: "Vulnerability",
        ruleType: "Security",
        pattern:
      ...
      // Supply Chain - Dependency Confusion (NEW for 2025)
      {
        ...
        description:
          "Unscoped package names can be vulnerable to dependency confusion attacks.",
        severity: "Major",
        type: "Security Hotspot",
        ruleType: "Security",
      ...
      // Eval Usage
      {
        ...
        description:
          "Review this code carefully as it executes dynamic code which could be exploited.",
        severity: "Major",
        type: "Security Hotspot",
        ruleType: "Security",
      ...
      // Logging Sensitive Data (NEW for 2025)
      {
        ...
        description:
          "Logging passwords, tokens, or other sensitive data exposes them to log readers.",
        severity: "Major",
        type: "Security Hotspot",
        ruleType: "Security",
        pattern:
      ...
      // Unhandled Exceptions (NEW for 2025 A10)
      {
        ...
        description:
          "Empty catch blocks or swallowing exceptions without logging can mask errors.",
        severity: "Major",
        type: "Bug",
      ...
      // Null Pointer Dereference
      {
        ...
        description:
          "Dereferencing a value that could be null will result in a runtime error.",
        severity: "Major",
        type: "Bug",
        ruleType: "Reliability",
      ...
      // Promise Without Catch
      {
        ...
        description:
          "Promises without proper error handling can cause silent failures.",
        severity: "Major",
        type: "Bug",
        ruleType: "Reliability",
      ...
      // Cognitive Complexity
      {
        ...
        description:
          "Functions with high cognitive complexity are hard to understand and maintain.",
        severity: "Major",
        type: "Code Smell",
        ruleType: "Maintainability",
        pattern:
          /function\s+\w+\s*\([^)]*\)\s*\{(?:[^}]*(?:if|else|while|for|switch|catch|&&|\|\|)){5,}/gi,
        languages: ["javascript", "typescript"],
      ...
      // Console.log in Production
      {
        ...
        description:
          "Console statements should be removed before pushing to production.",
        severity: "Minor",
        type: "Code Smell",
        ruleType: "Maintainability",
      ...
      // Commented Out Code
      {
        ...
        description:
          "Commented-out code makes the codebase harder to understand.",
        severity: "Minor",
        type: "Code Smell",
        ruleType: "Maintainability",
      ...
      // Unused Variables
      {
        ...
        description:
          "Unused variables consume memory and make code harder to read.",
        severity: "Minor",
        type: "Code Smell",
        ruleType: "Maintainability",
      ...
      // Magic Numbers
      {
        ...
        description:
          "Magic numbers make code less readable. Use named constants instead.",
        severity: "Minor",
        type: "Code Smell",
        ruleType: "Maintainability",
      ...
      // Inefficient Array Methods
      {
        ...
        description:
          "Using multiple array iterations when one would suffice is inefficient.",
        severity: "Minor",
        type: "Code Smell",
        ruleType: "Performance",
      ...
      // Zip Slip Vulnerability (NEW)
      {
        ...
        description:
          "Extracting zip archives without validating paths can lead to arbitrary file overwrite (Zip Slip).",
        severity: "Critical",
        type: "Vulnerability",
        ruleType: "Security",
      ...
      // Unsafe React href (NEW)
      {
        ...
        description:
          "Using javascript: protocol in href attributes can lead to XSS attacks.",
        severity: "Critical",
        type: "Vulnerability",
        ruleType: "Security",
      ...
      // HTTP Header Injection (NEW)
      {
        ...
        description:
          "User input in HTTP headers can lead to HTTP Response Splitting or Header Injection.",
        severity: "Critical",
        type: "Vulnerability",
        ruleType: "Security",
        pattern:
      ...
      // Reverse Tabnabbing (NEW)
      {
        ...
        description:
          'Using target="_blank" without rel="noopener noreferrer" exposes the page to Reverse Tabnabbing attacks.',
        severity: "Major",
        type: "Vulnerability",
        ruleType: "Security",
        pattern:
      ...
      // AWS Access Key (NEW)
      {
        ...
        description:
          "Hardcoded AWS Access Keys can lead to cloud account compromise.",
        severity: "Blocker",
        type: "Vulnerability",
        ruleType: "Security",
  ...
  private calculateMetrics(
    ...
    const codeSmells = issues.filter(
      (i) => i.rule.type === "Code Smell"
    ).length;
    const securityHotspots = issues.filter(
      (i) => i.rule.type === "Security Hotspot"
    ).length;

    // Duplication analysis (simplified)
    const { duplicatedBlocks, duplicatedLines } =
      this.analyzeDuplication(lines);

    // Technical debt
    const technicalDebtMinutes = issues.reduce(
      (sum, issue) => sum + issue.technicalDebt,
      0
    );
    const technicalDebtRatio =
      (technicalDebtMinutes / (linesOfCode * 0.06)) * 100; // 0.06 = 3.6 min per 60 LOC
   ...
   */
  private analyzeDuplication(lines: string[]): {
    duplicatedBlocks: number;
    duplicatedLines: number;
  } {
  ...
  private evaluateQualityGate(
    ...
    const conditions: Array<{
    ...
    }> = [
      {
        ...
        status: (metrics.vulnerabilities === 0 ? "OK" : "ERROR") as
          | "OK"
          | "ERROR",
      ...
      },
      {
        ...
        status: (metrics.maintainabilityIndex >= 65 ? "OK" : "ERROR") as
          | "OK"
          | "ERROR",
      ...
      },
      {
        ...
        status: (metrics.technicalDebtRatio <= 5 ? "OK" : "ERROR") as
          | "OK"
          | "ERROR",
      ...
      },
      {
        ...
        status: ((metrics.duplicatedLines / metrics.linesOfCode) * 100 <= 3
          ? "OK"
          : "ERROR") as "OK" | "ERROR",
        value: Number(
          ((metrics.duplicatedLines / metrics.linesOfCode) * 100).toFixed(1)
        ),
        threshold: 3,
      },
    ];
  ...
  private generateReferences(rule: SonarRule): string[] {
    ...
    refs.push(
      `https://rules.sonarsource.com/typescript/RSPEC-${rule.id.split(":")[1]}`
    );
