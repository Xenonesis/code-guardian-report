  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-12 px-4">
      <div className="max-w-6xl mx-auto space-y-8">
            ...
            {user ? (
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 space-y-2">
                  ...
                  <p className="text-sm"><strong>Display Name:</strong> {user.displayName || 'Not set'}</p>
                  <p className="text-sm"><strong>Email Verified:</strong> {user.emailVerified ? 'Yes' : 'No'}</p>
                  <p className="text-sm"><strong>Provider(s):</strong> {user.providerData.map(p => p.providerId).join(', ')}</p>
                </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>📝 How to Test Account Conflict</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-4 border border-blue-200 dark:border-blue-900">
              <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">Test Scenario 1: Google → Email/Password</h3>
            ...
            <div className="bg-green-50 dark:bg-green-950/20 rounded-lg p-4 border border-green-200 dark:border-green-900">
              <h3 className="font-semibold text-green-900 dark:text-green-100 mb-2">Test Scenario 2: Email/Password → Google</h3>
            ...
            <div className="bg-purple-50 dark:bg-purple-950/20 rounded-lg p-4 border border-purple-200 dark:border-purple-900">
              <h3 className="font-semibold text-purple-900 dark:text-purple-100 mb-2">Test Scenario 3: GitHub → Google</h3>
        ...
        {accountConflict.isOpen && (
          <Card className="border-2 border-amber-500">
            <CardHeader>
              <CardTitle className="text-amber-600 dark:text-amber-400">⚠️ Account Conflict Detected!</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-2 bg-amber-50 dark:bg-amber-950/20 rounded-lg p-4">
                <p><strong>Email:</strong> {accountConflict.email}</p>
                <p><strong>Existing Provider:</strong> {accountConflict.existingProvider}</p>
                <p><strong>Attempted Provider:</strong> {accountConflict.attemptedProvider}</p>
                <p><strong>Modal Open:</strong> Yes ✅</p>
              </div>
            </CardContent>
          </Card>
        )}
